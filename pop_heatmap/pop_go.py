...
sheet1 = pd.read_excel("来源去向分析.xlsx", sheet_name="来源地")
...
m.save('D:\workspace\PythonOutput\\pop_line_Income_cu.html')
webbrowser.open('D:\workspace\PythonOutput\\pop_line_Income_cu.html')
m_total.save('D:\workspace\PythonOutput\\pop_line_Income_total.html')
webbrowser.open('D:\workspace\PythonOutput\\pop_line_Income_total.html')
print(loc_s)
