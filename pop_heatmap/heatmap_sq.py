...
def draw_map_f(location_s=([31.0,121.0],[31.1,121.0])):
    ...
    for i in range(len(location_s)):
        folium.Rectangle(bounds=[(30.1,122.0),(31.0,121.0)],location=location_s[i]).add_to(m)
    # m.save(os.path.join(r'C:\Users\Desktop', 'Heatmap1.html'))
    m.save('D:\workspace\PythonOutput\\heatmap_sq_1.html')
    webbrowser.open('D:\workspace\PythonOutput\\heatmap_sq_1.html')
