...
if __name__ == '__main__':
    ...
    rootdir = 'F:\学校文件\大三\大三上\项目\伦敦、东京、曼哈顿、下城区\伦敦、东京、曼哈顿、下城区\Tokyo'
    ...
    for i in range(0, len(list)):
        ...
        if os.path.isfile(path):
            ...
            background.save("D:\workspace\PythonOutput\photo_1\photo_tokyo\ " + str2 + ".jpg")
            pal2.save("D:\workspace\PythonOutput\photo_1\photo_tokyo\ "+str3+".jpg")
