...
if __name__ == '__main__':
    ...
    rootdir = 'F:\学校文件\大三\大三上\项目\徐汇文定\徐汇文定'
    ...
    for i in range(0, len(list)):
        ...
        if os.path.isfile(path):
            ...
            background.save("D:\workspace\PythonOutput\photo_1\photo_xuhui\ " + str2 + ".jpg")
            pal2.save("D:\workspace\PythonOutput\photo_1\photo_xuhui\ "+str3+".jpg")
