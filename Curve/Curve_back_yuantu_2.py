...
if __name__ == '__main__':
    ...
    for i in range(0, len(list)):
        ...
        if os.path.isfile(path):
            ...
            background.save("D:\workspace\PythonOutput\photo_1\photo_2\ " + str2 + ".jpg")
            pal2.save("D:\workspace\PythonOutput\photo_1\photo_2\ "+str3+".jpg")
